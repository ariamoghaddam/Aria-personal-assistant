...
(async()=>{
  ...
  window.addEventListener('load',()=>setTimeout(async()=>{
    ...
    load('./ui-hub.js?v=3','ariaUiHub').catch(e=>console.error('ARIA command center load failed',e));
    load('./dashboard-unified.js?v=1','ariaUnifiedDash').catch(e=>console.error('ARIA unified dashboard load failed',e));
