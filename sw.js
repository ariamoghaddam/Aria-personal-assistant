...
self.addEventListener('push',event=>{
  ...
  const options={body:data.body||'یک یادآوری داری',tag:data.tag||'aria-reminder',renotify:true,silent:false,timestamp:Date.now(),data:data.url||'./'};
